...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout = QtWidgets.QFormLayout(self.gbBuscarImagen)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("icons/icon-th.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnListDown.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/iconos/filter"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnFiltro.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/iconos/invertFilter"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnFiltro_Invertir.setIcon(icon9)
