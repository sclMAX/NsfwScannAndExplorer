...
class Ui_dlgNsfwScanner(object):
    def setupUi(self, dlgNsfwScanner):
        ...
        dlgNsfwScanner.resize(1115, 590)
        ...
        self.chkMiniaturas = QtWidgets.QCheckBox(self.groupBox_2)
        self.chkMiniaturas.setChecked(True)
        self.chkMiniaturas.setObjectName("chkMiniaturas")
        self.verticalLayout_3.addWidget(self.chkMiniaturas)
    ...
    def retranslateUi(self, dlgNsfwScanner):
        ...
        self.groupBox_2.setTitle(_translate("dlgNsfwScanner", "Configuracíon"))
        self.chkMiniaturas.setToolTip(_translate("dlgNsfwScanner", "<html><head/><body><p>Si esta Activado crea miniaturas durante elproceso de escaneo.</p></body></html>"))
        self.chkMiniaturas.setText(_translate("dlgNsfwScanner", "Crear miniaturas"))
        self.label.setText(_translate("dlgNsfwScanner", "Filtro por Probabilidad "))
