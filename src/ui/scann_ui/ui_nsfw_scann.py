...
class Ui_dlgNsfwScanner(object):
    def setupUi(self, dlgNsfwScanner):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/iconos/scann"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.chkIsScannVideos = QtWidgets.QCheckBox(self.groupBox_2)
        self.chkIsScannVideos.setChecked(True)
        self.chkIsScannVideos.setObjectName("chkIsScannVideos")
        self.verticalLayout_3.addWidget(self.chkIsScannVideos)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/iconos/pause"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/iconos/ok"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/iconos/cancel"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, dlgNsfwScanner):
        ...
        self.btnVIC.setToolTip(_translate("dlgNsfwScanner", "Escanear desde Reporte VIC 1.3."))
        ...
        self.chkGif_as_frame.setToolTip(_translate("dlgNsfwScanner", "Si esta activado escanea los GIF por frames como a los videos, de lo contrario los escanea como imagenes."))
        self.chkGif_as_frame.setText(_translate("dlgNsfwScanner", "Escanear GIF por frames"))
        self.chkIsScannVideos.setToolTip(_translate("dlgNsfwScanner", "Si esta activado escanea los Videos, de lo contrario los omite."))
        self.chkIsScannVideos.setText(_translate("dlgNsfwScanner", "Escanear Videos"))
        ...
        self.btnStart.setToolTip(_translate("dlgNsfwScanner", "Iniciar Escaneo."))
        self.btnPause.setToolTip(_translate("dlgNsfwScanner", "Pausar Proceso."))
        self.btnAceptar.setToolTip(_translate("dlgNsfwScanner", "Cerrar y cargar reporte creado."))
