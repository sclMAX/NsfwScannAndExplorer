...
class Ui_dlgNsfwScanner(object):
    def setupUi(self, dlgNsfwScanner):
        ...
        self.video = QtWidgets.QFrame(self.groupBox)
        ...
        self.video_frame.setMinimumSize(QtCore.QSize(256, 256))
        ...
        self.horizontalLayout_3.addWidget(self.video, 0, QtCore.Qt.AlignTop)
